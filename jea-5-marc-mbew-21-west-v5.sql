...
-- Singelartikel, får nytt artikelnummer = 21; AI "Variant/produkt" = S Singelartikel utan "kompisar".
...
WITH cte_artnr_west AS (
  ...
  WHERE
    ...
    AND ar_2000.extra4 IN (21)  -- Change v.5.
/* Remove v.5.
...
--  CAST(GETDATE() AS date) AS MARC_RUN_ID,  -- Remove v.1.
  ...
  'SP' AS MARC_MTVFP,  -- SAP availability check. Change v.1.
