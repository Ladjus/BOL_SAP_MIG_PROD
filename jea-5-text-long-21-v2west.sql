...
v.2w: !!!PacsOn Väst 9100 only!!!
     ...
     !!! Fork from jea-3-mard-11-12-w-v2.sql to jea-5-mard-21-w-v2.sql for articles with extra4 = 21 !!!
*/
...
cte_artnr_west AS (  -- Add v.2w.
  ...
  WHERE
    ...
    AND ar_2000.extra4 IN (21)  -- Change v.2w.
