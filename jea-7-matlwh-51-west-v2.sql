...
v.2: CTE cte_artnr_west: Select A/B-assortment plus C for PacsOn Väst.
     !!! Fork from jea-5-matlwh-21-w-v2.sql to jea-7-matlwh-51-w-v2.sql for articles with extra4 = 51 !!!
     Include Jeeves assortment values DA, DB, DC for duplicates of ECC articles.
     Column MATLWH_PRODUCT gets Pacudo-nr to match POI ECC (not: artbeskrspec, "Artikelnr").
*/
...
--  ar_2000.artbeskrspec AS MATLWH_PRODUCT,  -- SAP Product. Jeeves "Artikelnr". Remove v.4.
  ar_2000.q_artnr_pacudo AS MATLWH_PRODUCT,  -- SAP Product. Jeeves "Pacudo ArtNr". Add v.4.
--  CAST(GETDATE() AS date) AS MATLWH_RUN_ID,  -- Remove v.1.
  'WEST' AS MATLWH_RUN_ID,  -- Add v.1.
