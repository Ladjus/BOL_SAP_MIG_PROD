...
--    AND ar_2000.extra4 IN (11, 12)
    AND (ar_2000.q_saps4_sortiment <> 'C'  -- Ej C-sortiment, tag alla artiklar.
         OR (ar_2000.q_saps4_sortiment = 'C' AND ar_9100.artnr IS NOT NULL))  -- C-sortiment, tag endast de som finns i Väst.
)
SELECT
  ar.ForetagKod,
