...
-- Singelartikel m PH2, behåller artikelnummer = 11; AI "Variant/produkt" = P Singelartiklar som ska hållas ihop som en produkt i Artikelhierarki 2.
...
v.1: Initial. Select only A-assortment plus B/C for PacsOn Väst. Refer:
     ...
     !!! Fork from jea-3-prod-hierarchy-11-w-v1.sql to jea-5-prod-hierarchy-21-w-v1.sql for articles with extra4 = 21 !!!
*/
